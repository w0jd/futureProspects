...
namespace FutureProspects.Migrations
{
    ...
    [Migration("20230427194327_EmployeeOffer")]
    partial class EmployeeOffer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FutureProspects.Models.EmployeeOffer", b =>
                {
                    ...
                    b.HasKey("OfferId", "EmployeeId");

                    b.HasIndex("EmployeeId");

                    b.ToTable("EmployeeOffers");
                });
            ...
            modelBuilder.Entity("FutureProspects.Models.EmployeeOffer", b =>
                {
                    b.HasOne("FutureProspects.Models.Employee", "Employee")
                        .WithMany("EmployeeOffer")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FutureProspects.Models.Offer", "Offer")
                        .WithMany("EmployeeOffer")
